...
<body>
   ...
   <div class="box-container">
      ...
      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` where deal='YES'") or die('query failed');
     ...
     <form action="" method="post" class="box">
      ...
      <div class="price">LKR <?php echo $fetch_products['price']; ?></div>
		 <div class="pricedisc"> <div class="pricedis">LKR <strike><?php echo $fetch_products['price']; ?></strike></div>  <div class="price">LKR <?php echo $fetch_products['new_price']; ?></div></div>
