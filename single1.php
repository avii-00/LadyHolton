    ...
    <?php
                  ...
                  $result2 = mysqli_query($conn, $sql2); 
                      ...
                      $row2 = mysqli_fetch_assoc($result2)
                          ?> 
     Categories - <a href="../../shoping-cart/index.php?id=<?php echo $cat_id ?>"><?php echo $row2["cat_name"] ?></a>   
...
//  }
 ...
 ?>
                ...
                <li>
                    ...
                    <a href="../../shoping-cart/single.php?id=<?php echo $row_related['product_id']; ?>" class="btn btn-default btn-xs pull-left">
...
<?php include('../../shoping-cart/inc/footer.php');  ?>
